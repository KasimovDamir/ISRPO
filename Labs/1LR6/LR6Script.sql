...
/****** Object:  Database [Publ]    Script Date: 18.12.2025 17:00:47 ******/
DROP DATABASE [Publ]
GO
...
CREATE DATABASE [Publ]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Publ', FILENAME = N'D:\SQLServer\MSSQL16.SQLLUM1E\MSSQL\DATA\Publ.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Publ_log', FILENAME = N'D:\SQLServer\MSSQL16.SQLLUM1E\MSSQL\DATA\Publ_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Publ] SET RECOVERY SIMPLE 
GO
